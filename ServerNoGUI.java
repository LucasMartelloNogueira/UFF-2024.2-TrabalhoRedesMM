...
public class ServerNoGUI{
    ...
    public ServerNoGUI() {
      ...
      timer = new WaitingTimer(FRAME_PERIOD, FRAME_PERIOD);
    ...
    public static void main(String argv[]) throws Exception {
      ...
      ServerNoGUI theServer = new ServerNoGUI();
      ...
      public void run() {
        ...
        if (imagenb < VIDEO_LENGTH) {
          ...
          try {
            ...
            System.out.printf("[SERVIDOR] - enviou pacote %d\n", imagenb);
          ...
          // send frame with -1 sequence number to signalize end

          rtp_packet = new RTPpacket(MJPEG_TYPE, -1, imagenb * FRAME_PERIOD, buf, image_length);
          packet_length = rtp_packet.getlength();
          packet_bits = new byte[packet_length];
          rtp_packet.getpacket(packet_bits);
          senddp = new DatagramPacket(packet_bits, packet_length, ClientIPAddr, RTP_dest_port);
